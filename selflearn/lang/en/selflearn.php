...
$string['help::course_selection_help'] = 'With the options "Limit to self-created content" and "Search by course title", the search can be narrowed down. Up to 10 results are displayed in the selection field. To create the SelfLearn activity, a course must be selected.';
